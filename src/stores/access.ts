...
import { ROOT_ROUTE_ID } from "@/router/routes/constants";
import type { AppRouteRecordRaw } from "@/router/types";
import { ascending } from "@/router/utils/ascending";
import { flattenRoutes } from "@/router/utils/flatten-routes";
import { generateMenuItemsFromRoutes } from "@/router/utils/generate-menu-items-from-routes";
